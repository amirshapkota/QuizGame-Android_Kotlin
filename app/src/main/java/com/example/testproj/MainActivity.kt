...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var questionTextView: TextView // Initialized here
    ...
    private lateinit var questionNumberButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionTextView = findViewById(R.id.questionTextView) // Ensure initialization
        progressBar = findViewById(R.id.progressBar)
        timerTextView = findViewById(R.id.timerTextView)
        scoreTextView = findViewById(R.id.scoreTextView)
        title = findViewById(R.id.title)
        questionNumberButton = findViewById(R.id.questionNumberButton)
    ...
    private fun showNextQuestion() {
        ...
        updateQuestionUI()
        startTimer()
        questionNumberButton.text = "    Question $currentQuestionNumber/50    "
